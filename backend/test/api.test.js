...
const ai_service_js_1 = require("../src/modules/ai/ai.service.js");
const matching_service_js_1 = require("../src/modules/matching/matching.service.js");
const ledger_service_js_1 = require("../src/modules/payments/ledger.service.js");
...
async function runTests() {
    ...
    try {
        ...
        const aiResult = await ai_service_js_1.AIService.classifyImage('https://images.unsplash.com/sample-laptop.jpg', 'ThinkPad Core i7');
        ...
        const blurryResult = await ai_service_js_1.AIService.classifyImage('https://example.com/unknown_blur.png');
        ...
        const collectorUser = await prisma_js_1.prisma.user.findFirst({ where: { role: 'collector' } });
        ...
        const releaseResult = await ledger_service_js_1.LedgerService.releaseEscrow({
        ...
        const integrity = await ledger_service_js_1.LedgerService.verifyWalletIntegrity((await ledger_service_js_1.LedgerService.getOrCreateWallet(collectorUser.id)).id);
